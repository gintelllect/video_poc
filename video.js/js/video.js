...
(function() {
    ...
    s.volume = function(a) {
        if (a !== b) return a = Math.max(0, Math.min(1, parseFloat(a))), this.K.volume = a, N(this, "setVolume", a), t.Je(a), this;
    ...
    t.f = t.j.extend({
        l: function(a, c, d) {
            ...
            (c = c.source) && (this.c.currentSrc !== c.src || a.L && 3 === a.L.de) && this.ma(c);
            if (this.c.hasChildNodes()) {
                d = this.c.childNodes;
                e = d.length;
                for (c = []; e--;) g = d[e], h = g.nodeName.toLowerCase(), "track" === h && (this.featuresNativeTextTracks ? P(this.Y(), g.track) : c.push(g));
                for (d = 0; d < c.length; d++) this.c.removeChild(c[d])
            }
            this.featuresNativeTextTracks &&
                this.b("loadstart", t.bind(this, this.be));
    ...
    s.e = function() {
        ...
        if (!g || this.movingMediaElementInDOM === l) {
            g ? (e = g.cloneNode(l), t.f.Kb(g), g = e, a.L = j) : (g = t.e("video"), e = videojs.Z.Aa({}, a.Ue), (!t.Db || a.options().nativeControlsForTouch !== f) && delete e.controls, t.ad(g, t.i.D(e, {
                id: a.id() + "_html5_api",
                "class": "vjs-tech"
            })));
            g.player = a;
    ...
    s.be = function() {
        for (var a = this.c.querySelectorAll("track"), c, d = a.length, e = {
            ...
            if ((c = a[d].S) && c.kind in e && !a[d]["default"]) c.mode = "disabled"
    };
    s.Td = function(a) {
    ...
    var ya, V, xa;
    ya = function(a, c) {
        t.cf(a, t.bind(this, function(a, e, g) {
    ...
    t.V = function(a) {
        var c = this,
            d;
        if (t.pa)
            for (d in c = document.createElement("custom"), t.V.prototype) c[d] = t.V.prototype[d];
    ...
    t.sa.prototype.C = function() {
        ...
        this.Md();
        if (a)
            for (; c < a.length; c++) d = a[c], "showing" === d.mode && this.$e(d)
    };
            ...
            e && (g = t.bind(this, function() {
                ...
                if (this instanceof t.zb) {
                    ...
                    for (g = e.length; d < g; d++)
                        if (c = e[d], c.kind === this.S.kind && "showing" === c.mode) {
                            a = l;
                            break
                        }
                }
    ...
    t.$.prototype.u = function() {
        ...
        t.M.prototype.u.call(this);
        if (c)
            for (; e < c.length; e++) d = c[e], d.kind === a && (d.mode = d === this.S ? "showing" : "disabled")
    };
    t.zb = t.$.extend({
        l: function(a, c) {
            c.track = {
